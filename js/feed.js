...
const TEMPLATES = [
  () => ({ text: `ping wishes.dirosan.com ${8 + Math.floor(Math.random() * 30)}ms`, ok: true }),
  () => ({ text: `ping movies.dirosan.com ${8 + Math.floor(Math.random() * 30)}ms`, ok: true }),
  () => ({ text: `ping trips.dirosan.com ${8 + Math.floor(Math.random() * 30)}ms`, ok: true }),
